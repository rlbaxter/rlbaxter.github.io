...
<head>
	<meta charset="UTF-8">
	<title>Product Bootcamp - Courses</title>
		...
		<section class="courses ux">
			...
			<nav class="course-track-nav">
				...
				<div class="track-options">
					<ul>
						<!--Mobile Order: Actual Order. Desktop Order: Class Names. Bless you Flexbox-->
						<li class="order-1"><span class="active">UX</span></li>
						<li class="order-2"><a href="courses-pm.html">Product Management</a></li>
						<li class="order-3"><a href="courses-research.html">Reseasch</a></li>
						<li class="order-4"><a href="courses-leadership.html">Leadership</a></li>
					</ul>
				</div>
			</nav>
